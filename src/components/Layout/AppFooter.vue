  ...
  <div class="app-footer">
    <div class="footer-content">
      ...
      <div class="icp-info">
        ...
        <a href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=2021000340" target="_blank" rel="noopener noreferrer">渝ICP备2021000340号-15</a>
      </div>
      <div class="disclaimer-text">
          NB.STOCK 是一款由人工智能驱动的多智能体股票分析辅助工具，不具备证券投资咨询资质。平台内提供的所有分析结果、评分及参考意见，均由 AI 基于公开历史数据自动生成，仅供学习、研究及技术交流使用，不构成任何形式的投资建议或决策依据。

股票市场受多种因素影响，存在市场风险、流动性风险、政策风险等，投资者可能面临本金损失的风险。用户应基于自身风险承受能力独立审慎决策。因使用本工具所产生的任何投资行为及其后果，均由用户自行承担。
