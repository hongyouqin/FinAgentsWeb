  ...
  <div class="landing-page">
    ...
    <div class="landing-footer">
      <div class="footer-brand">
        <strong>TradingAgents 中文版</strong>
        <span class="brand-divider">|</span>
        <span class="brand-desc">多智能体 AI 金融交易决策框架</span>
      </div>
      <div class="footer-disclaimer">仅供研究与教育用途，不构成投资建议。</div>
      <div class="copyright">© 2026 TradingAgents-CN. All rights reserved.</div>
      <div class="icp-info">
...
.landing-footer {
  ...
  .footer-brand {
    ...
    .brand-divider { color: rgba(255, 255, 255, 0.2); }
    .brand-desc { color: rgba(255, 255, 255, 0.55); font-size: 13px; }
  }
